...
function stDistance_MisDensity(dis_limit)
...
for id=1:length(log_dis_limit_Mission(:,1))    
    ...
    stat_distance_limit_Mission_price_Mean(id,1)=mean(valid_Mission_price);
    stat_distance_limit_Mission_price_Sum(id,1)=sum(valid_Mission_price);
    stat_distance_limit_Mission_price_Std(id,1)=std(valid_Mission_price);    
end
