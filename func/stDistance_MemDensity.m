...
function [stat_distance_limit_Member_Count,stat_distance_limit_Member_Credit_Mean,...
    ...
    stat_distance_limit_Member_Distance_Sum,stat_distance_limit_Member_Distance_Std]=stDistance_MemDensity(dis_limit)
...
for id=1:length(log_dis_limit_Member(:,1))
    ...
    stat_distance_limit_Member_Credit_Mean(id,1)=median(valid_Member_Credit);
    stat_distance_limit_Member_Credit_Sum(id,1)=sum(valid_Member_Credit);
    stat_distance_limit_Member_Credit_Std(id,1)=iqr(valid_Member_Credit);
    ...
    stat_distance_limit_Member_Distance_Mean(id,1)=median(valid_Member_Distance);
    stat_distance_limit_Member_Distance_Sum(id,1)=sum(valid_Member_Distance);
    stat_distance_limit_Member_Distance_Std(id,1)=iqr(valid_Member_Distance);
end
